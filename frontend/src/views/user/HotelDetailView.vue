...
import { ChevronLeft, MapPin, Phone, BedDouble } from "@lucide/vue";
...
<template>
  <div class="container mx-auto max-w-5xl">
    ...
    <div v-else-if="hotel">
        ...
        <CardContent class="p-6">
          <div class="mb-3 flex items-start justify-between">
            <div>
              ...
              <div v-if="hotel.starLevel" class="mt-1 text-amber-500">
      ...
      <!-- Room List -->
      <div>
        <h2 class="mb-4 text-xl font-semibold text-gray-900">客房类型</h2>
        ...
        <div v-else class="space-y-4">
          <Card v-for="room in rooms" :key="room.id" class="overflow-hidden">
            <CardContent class="flex flex-col gap-4 p-4 sm:flex-row">
              <!-- Room Image -->
              <div
                class="h-32 w-full shrink-0 overflow-hidden rounded-md bg-gray-100 sm:h-28 sm:w-40"
              >
                <img
              ...
              <div class="flex flex-1 flex-col justify-between">
                <div>
                  <div class="mb-1 flex items-center gap-2">
                    ...
                    <Badge
                      :variant="
                        room.availableQuantity > 0 ? 'default' : 'secondary'
                      "
                      :class="
