...
<template>
  ...
  <section class="-mx-4 bg-blue-900 px-4 py-12">
    <div class="container mx-auto max-w-4xl">
      ...
      <p class="mb-8 text-center text-blue-200">搜索全国优质酒店，轻松预订</p>
      ...
      >
        <Button
          ...
          @click="
            hotelStore.fetchHotels({
              ...searchParams,
              page: (hotelStore.pagination?.currentPage ?? 1) - 1,
            })
          "
        >
          上一页
        ...
        <span class="text-sm text-gray-500">
          {{ hotelStore.pagination.currentPage }} /
          {{ hotelStore.pagination.totalPages }}
        </span>
        <Button
          variant="outline"
          size="sm"
