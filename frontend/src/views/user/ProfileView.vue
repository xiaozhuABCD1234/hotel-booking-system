        ...
        <TabsContent value="profile" class="mt-4">
          <Card>
              ...
              <div class="flex items-center gap-4">
                <Avatar class="h-14 w-14">
                  <AvatarFallback class="text-lg">
                    {{ user?.username?.charAt(0)?.toUpperCase() ?? (userLoading ? '?' : '!') }}
                  </AvatarFallback>
                </Avatar>
                <div>
                  <CardTitle class="text-lg">
                    <span v-if="userLoading" class="inline-block h-5 w-24 animate-pulse rounded bg-muted" />
                    <span v-else-if="userError">无法加载用户信息</span>
                    <span v-else>{{ user?.username ?? '未知用户' }}</span>
                  </CardTitle>
                  <CardDescription class="text-gray-500">用户名不可修改</CardDescription>
                </div>
              </div>
            </CardHeader>
            <Separator />
            ...
            <CardFooter v-if="!userLoading">
              <Button class="bg-blue-900 hover:bg-blue-800" :disabled="savingProfile" @click="saveProfile">
        ...
        <TabsContent value="vip" class="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription class="text-gray-500">查看您的会员等级和积分信息</CardDescription>
            </CardHeader>
            <Separator />
            <CardContent class="pt-6">
              ...
              <div v-else class="space-y-4">
                ...
                <Separator />
                <div class="flex items-center justify-between">
                  <span class="text-sm font-medium text-gray-500">距下一等级积分</span>
                  <span class="font-medium">
        ...
        <TabsContent value="password" class="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription class="text-gray-500">定期修改密码有助于保护账户安全</CardDescription>
            </CardHeader>
            <Separator />
            <CardContent class="pt-6">
              <FieldGroup class="gap-4">
                ...
                <Field :data-invalid="!!passwordErrors.newPassword || undefined">
                  ...
                  />
                  <FieldDescription>建议使用字母、数字和特殊字符的组合</FieldDescription>
            ...
            <CardFooter>
              <Button class="bg-blue-900 hover:bg-blue-800" :disabled="changingPassword" @click="changePassword">
