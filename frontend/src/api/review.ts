...
export const reviewApi = {
  list(page = 1, pageSize = 10) {
    return api.get<ApiResponse<Review[]>>("/reviews", {
  ...
  listByHotel(hotelId: string, page = 1, pageSize = 10) {
    return api.get<ApiResponse<Review[]>>(`/reviews/by-hotel`, {
      params: { hotelID: hotelId, page, pageSize },
    });
  },

  listByUser(userId: string, page = 1, pageSize = 10) {
    return api.get<ApiResponse<Review[]>>(`/reviews/by-user`, {
  ...
  reviewFullByHotel(hotelId: string, page = 1, pageSize = 10) {
    return api.get<ApiResponse<ReviewFull[]>>(`/reports/review-full/by-hotel`, {
      params: { hotelID: hotelId, page, pageSize },
    });
  },

  reviewFullByUser(userId: string, page = 1, pageSize = 10) {
    return api.get<ApiResponse<ReviewFull[]>>(`/reports/review-full/by-user`, {
      params: { userID: userId, page, pageSize },
    });
  },
};
