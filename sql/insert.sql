...
VALUES ('320102200003150018', '张伟', '13800001111', '学生', '本科', '[0, 5000)'),
    ('310115199807120026', '李娜', '13800002222', '软件工程师', '硕士', '[20000, 30000)'),
    ('110108198511090015', '王强', '13800003333', '销售经理', '本科', '[15000, 25000)'),
    ('440106197602280024', '赵敏', '13800004444', '医生', '博士', '[30000, 50000)'),
    ('330102196510220019', '陈建国', '13800005555', '企业高管', '硕士', '[50000, 100000)'),
    ('510104199203080042', '刘芳', '13800006666', '教师', '硕士', '[10000, 20000)');
-- 地区数据（省/市/区 三级层次）
